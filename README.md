...
The goal of toyExample is to make regular expressions more exciting! It
provides convenience functions to male some common tasks with string
manipulation and regular expressions a bit easier.

## Installation

You can install the development version of toyExample from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("javibio-git/toyExample")
```
...
That’s exactly what `toyExample::str_split_one()` does.
